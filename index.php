...
// try {
  ...
  $query = "SELECT `name`, `department`, `pass_name`, `location`, `bus`,
  `date_departure`, `time_departure`, `exp_arrival`, `time_arrival`, `passengers`,
  `purpose`,`file_name`, `destination_name`
  FROM `bus` order by `name` asc;";
                              ...
                              <div class="modal-dialog modal-xl">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h1 class="modal-title fs-5" id="staticBackdropLabel">Booked List</h1>
                        ...
                        <table id="all_patients"
                            ...
                            while($row =$stmtPatient1->fetch(PDO::FETCH_ASSOC)){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['date_departure'];?></td>
                                    <td><?php echo $row['time_departure'];?></td>
                                    <td><?php echo $row['exp_arrival'];?></td>
